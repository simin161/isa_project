...
template: `
		<div>
		<nav-bar></nav-bar>
		<p class="title-text-bold"> Hello, {{dto.firstName}} {{dto.lastName}} </p>
         <div class="containter">
             <div class="col-md-4 left-div">
                ...
                <br>
                    <input type="text" class="input-text-profile-small" v-model="dto.firstName" :disabled="true" placeholder="First name"/>
                    <input type="text" class="input-text-profile-small" v-model="dto.lastName" :disabled="true" placeholder="Last name"/>
                <br>
                    <input type="text"  class="input-text-profile" v-model="dto.address" :disabled="true" placeholder="Address"/>
                <br>
                    <input type="text" class="input-text-profile-small" v-model="dto.city" placeholder="City" :disabled="true"/>
                    <input type="text" class="input-text-profile-small" v-model="dto.country" placeholder="Country" :disabled="true"/>
                <br>
                    <input type="text"  class="input-text-profile" v-model="dto.phoneNumber" placeholder="Phone number" :disabled="true"/>
                <br>
                <div v-if="dto.userType == 'CUSTOMER' && dto.loyaltyProgram != null">
                    <input type="text" class="input-text-profile-small" v-model="dto.loyaltyProgram.categoryName" :disabled="true" placeholder="Category name"/>
                </div>
                <div v-else-if="dto.userType == 'CUSTOMER' && dto.loyaltyProgram == null">
                    <input type="text" class="input-text-profile-small" :disabled="true" placeholder="No category"/>
                </div>
                <input type="text" class="input-text-profile-small" v-model="dto.earnedPoints" :disabled="true"/>
             ...
             <div class="col-md-4 right-div">
                ...
                <div class="align-items-start" v-show="showForm == 2">
                    <p class="title-text-bold">Change your password</p>
                    <form style="margin-left: 15%;"  class="col-md-2">
                        <table style="margin-top: 10%;">
                            ...
                            <br>
                            <tr>
                            <td><input style="background-color: gray" class="confirm" type="button" value="Back to Options" @click="backToOptions"/></td>
                            </tr>
                        </table>
                    </form>
                </div>
                ...
                <div class="align-items-start" v-show="showForm == 3">
                  ...
                  <div class="align-items-start" v-show="showForm == 1">
