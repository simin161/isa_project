    	...
    	<div>
                ...
                <div class="col-md-4 right-div overflow-auto" style="margin-top:-20px; height:80vh" v-show="showPage == 3">
                                <div class="container" v-show="showPage == 3">
                                	<div class="container align-items-start">
                                		...
                                		<form class="justify-content-center">
                                			<table class="justify-content-center" style="width:75%; margin: auto; table-layout:fixed;" >
                                				<tr><td><input type="text" placeholder="   Course's name" class="input-text" v-model="boatToShow.offerName"/></td></tr><br>
                                				<tr class="d-flex justify-content-evenly">
                                				    <td><input type="text" placeholder="   First name" class="input-text" v-model="boatToShow.user.firstName"/></td>
                                				    <td><input type="text" placeholder="   Last name"  class="input-text" v-model="boatToShow.user.lastName"/></td>
                                				</tr>
                                				<br>
                                                <br>
          ...
          methods : {
            ...
            addComplaint : function(){
                this.complaint.offer = this.boatToShow;
