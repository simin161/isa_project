...
INSERT INTO public.users(
	id, address, city, country, email, first_name, is_activated, is_deleted, last_name, last_password_reset_date, number_of_log_ins, password, phone_number, user_type, verification_code)
	VALUES (5, 'a', 'a', 'a', 'admin', 'Dragana', true, false, 'Mirkovic', '01-01-0001', 0, '$2a$10$S0qDDlMfhXUvj4bfwqtV9O2lEDkBPl1KEWl2MOtUtmSw9AdWO2VlG', '12345678', 4, '');
...
INSERT INTO public.offer(
  	id, additional_services, cancellation_policy, description, max_customer_capacity, offer_name, offer_type, rating, rules_of_conduct, unit_price, users, location)
    values(3, 'A lot of additional services _namyg_', 'No cancellation policies _namyg_', 'Very hot and sexy bungy', 2, 'Coursy wumby', 1, 5.0, 'Sex, drugs and alcohol', 10.5, 3, 1);
INSERT INTO course values('dildo', 3);
INSERT INTO public.offer(
  	id, additional_services, cancellation_policy, description, max_customer_capacity, offer_name, offer_type, rating, rules_of_conduct, unit_price, users, location)
    values(4, 'A lot of additional services _namyg_', 'No cancellation policies _namyg_', 'Very hot and sexy bungy', 2, 'Coursy wumby', 1, 5.0, 'Sex, drugs and alcohol', 10.5, 4, 1);
